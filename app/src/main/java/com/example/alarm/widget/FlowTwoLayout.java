 ...
 */
public class FlowTwoLayout extends ViewGroup {
    ...
    public FlowTwoLayout(Context context) {
        this(context, null);
    }

    public FlowTwoLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowTwoLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public class ViewHolder {
        ...
        public void setText(int viewId, final String text) {
